class ResponseTopArtists {
  Topartists topartists;

  ResponseTopArtists({this.topartists});

  ResponseTopArtists.fromJson(Map<String, dynamic> json) {
...
class Topartists {
  ...
  Topartists.fromJson(Map<String, dynamic> json) {
    ...
    attr = json['@attr'] != null ? new AttrPage.fromJson(json['@attr']) : null;
  }
...
class AttrPage {
  ...
  AttrPage({this.page, this.perPage, this.user, this.total, this.totalPages});

  AttrPage.fromJson(Map<String, dynamic> json) {
    page = json['page'];
